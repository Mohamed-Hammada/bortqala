...
public class BiometricDevice {
    ...
    @Column(name = "device_username", length = 150)
    private String username;
    @Column(name = "device_password_enc", length = 1000)
    ...
    @Column(name = "last_successful_punch_at")
    private Instant lastSuccessfulPunchAt;
    ...
    public Instant getLastSuccessfulPunchAt() {
        return lastSuccessfulPunchAt;
    }
