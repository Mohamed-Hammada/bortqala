...
public class ApprovalInstance {
    ...
    @Column(name = "document_snapshot_json", nullable = false, length = 4000)
    private String documentSnapshotJson;
    @Column(name = "step_due_at")
    private Instant stepDueAt;
    ...
    public void advanceStep(int nextStepOrder) {
        advanceStep(nextStepOrder, null);
    }
    ...
    public boolean isOverdue(Instant now) {
        return stepDueAt != null && now.isAfter(stepDueAt) && completedAt == null;
    }
    ...
    private void setDue(Integer hours) {
        stepDueAt = hours == null || hours <= 0 ? null : Instant.now().plusSeconds(hours * 3600L);
    }
