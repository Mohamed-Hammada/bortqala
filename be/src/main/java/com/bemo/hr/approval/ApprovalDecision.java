...
public class ApprovalDecision {
    ...
    @Column(name = "step_id", nullable = false, length = 36) private String stepId;
    @Column(nullable = false, length = 30) private String decision;
    @Column(length = 1000) private String comment;
    @Column(name = "decided_by", nullable = false, length = 160) private String decidedBy;
    @Column(name = "decided_at", nullable = false) private Instant decidedAt;
    @Column(name = "delegated_from", length = 160) private String delegatedFrom;
    ...
    @PrePersist void prePersist() { decidedAt = Instant.now(); }
}
