...
public class AttendanceReportDecision {
    ...
    @Column(name = "result_id", nullable = false) private String resultId;
    ...
    @Column(name = "previous_decided_by", length = 100) private String previousDecidedBy;
    @Column(name = "previous_decided_at") private Instant previousDecidedAt;
    @Enumerated(EnumType.STRING) @Column(name = "new_decision", nullable = false, length = 30) private AttendanceDecision newDecision;
    @Column(name = "new_manual_minutes") private Integer newManualMinutes;
    @Column(name = "new_note", length = 500) private String newNote;
    ...
    public AttendanceDecision getNewDecision() { return newDecision; }
    public Integer getNewManualMinutes() { return newManualMinutes; }
