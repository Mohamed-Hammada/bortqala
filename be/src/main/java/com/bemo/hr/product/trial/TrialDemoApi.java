...
public final class TrialDemoApi {
    ...
    public record StartRequest(@Min(1) @Max(90) int days, boolean demo, String templateCode, Integer templateVersion, @NotBlank String operationId) { }
    ...
    public record StatusResponse(String tenantId, String commercialState, long trialStartedAt, long trialEndsAt, long convertedAt,
