...
public class SubscriptionChange {
    ...
    @Column(name = "from_plan", length = 40)
    private String fromPlan;
    @Column(name = "to_plan", nullable = false, length = 40)
    ...
    public SubscriptionChange(String fromPlan, String toPlan, String fromStatus, String toStatus, String reason, String operationId, String actor) {
