...
public class SupplierInvoice {
    ...
    @Column(name = "internal_reference", nullable = false, length = 50)
    private String internalReference;
    @Column(name = "missing_invoice_reason", length = 255)
    private String missingInvoiceReason;
    ...
    public String getDocumentReference() {
        return invoiceNumber != null ? invoiceNumber : internalReference;
    }
    ...
    public String getMissingInvoiceReason() {
        return missingInvoiceReason;
    }
