...
@Entity
@Table(name = "ar_collection_tasks")
@Getter
public class CollectionTask {
    ...
    public CollectionTask(String invoiceId) {
    ...
    public void update(Status status, String owner, LocalDate next, String note) {
        this.status = status;
        ownerUserId = blank(owner);
        nextActionDate = next;
        this.note = blank(note);
    }
