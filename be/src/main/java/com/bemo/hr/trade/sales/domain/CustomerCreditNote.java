...
public class CustomerCreditNote {
    ...
    @Column(name = "credit_note_number", nullable = false, length = 50) private String creditNoteNumber;
    ...
    @Column(name = "sales_order_id", nullable = false, length = 36) private String salesOrderId;
    ...
    @Column(name = "credit_date", nullable = false) private LocalDate creditDate;
    ...
    public CustomerCreditNote(String number, String customerId, String invoiceId, String salesOrderId,
        ...
        this.id = UUID.randomUUID().toString(); this.creditNoteNumber = number; this.customerId = customerId;
        this.invoiceId = invoiceId; this.salesOrderId = salesOrderId; this.deliveryId = deliveryId;
        this.returnId = returnId; this.creditDate = date; this.currencyCode = currencyCode;
        this.amount = amount; this.operationId = operationId; this.createdBy = createdBy;
    }
