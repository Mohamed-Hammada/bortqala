...
public class ProcurementThreeWayMatch {
    ...
    @Column(name = "price_variance_amount", precision = 19, scale = 2)
    private BigDecimal priceVarianceAmount;
    @Column(name = "quantity_variance_amount", precision = 19, scale = 2)
    private BigDecimal quantityVarianceAmount;
