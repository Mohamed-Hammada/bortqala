...
public class SalesDeliveryLine {
    ...
    @Column(name = "sales_order_line_id", nullable = false, length = 36)
    ...
    @Column(name = "unit_cogs", nullable = false, precision = 19, scale = 6)
    private BigDecimal unitCogs;
    @Column(name = "cogs_amount", nullable = false, precision = 19, scale = 2)
