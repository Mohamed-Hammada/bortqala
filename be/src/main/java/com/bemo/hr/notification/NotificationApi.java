...
public final class NotificationApi {
    ...
    public record SendNotificationPayload(
            ...
            @Size(max = 500) String impactAr, @Size(max = 500) String impactEn, @Size(max = 500) String reasonAr,
            @Size(max = 500) String reasonEn,
            @Size(max = 500) String recommendationAr, @Size(max = 500) String recommendationEn,
            @DecimalMin("0") BigDecimal impactAmount, @Pattern(regexp = "[A-Z]{3}") String impactCurrency,
            @Size(max = 120) String actionLabelKey, @Size(max = 20) List<@Size(max = 50) String> roleTargets
    ) {
        public SendNotificationPayload(String recipientUsername, String titleAr, String titleEn, String messageAr, String messageEn, String notificationType, String priority, String actionLink) {
            this(recipientUsername, titleAr, titleEn, messageAr, messageEn, notificationType, priority, actionLink, null, null, null, null, null, null, null, null, null, null, null);
        }
    }
}
