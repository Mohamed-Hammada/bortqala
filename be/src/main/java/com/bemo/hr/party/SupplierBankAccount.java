...
public class SupplierBankAccount {
    ...
    @Column(name = "iban", nullable = false, length = 100) private String iban;
    @Column(name = "normalized_iban", nullable = false, length = 100) private String normalizedIban;
    ...
    @Column(name = "verification_status", nullable = false, length = 20) private String verificationStatus;
    ...
    public static String normalize(String value) { return value == null ? "" : value.replaceAll("[^A-Za-z0-9]", "").toUpperCase(Locale.ROOT); }
