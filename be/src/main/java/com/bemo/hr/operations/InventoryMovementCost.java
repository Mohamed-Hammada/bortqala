...
public class InventoryMovementCost {
    ...
    @Column(name = "quantity_effect", nullable = false, precision = 19, scale = 4)
    private BigDecimal quantityEffect;
    @Column(name = "unit_cost", nullable = false, precision = 19, scale = 6)
    private BigDecimal unitCost;
    @Column(name = "value_effect", nullable = false, precision = 19, scale = 2)
    private BigDecimal valueEffect;
