...
public class StockMovement {
    ...
    @Column(name = "purchase_order_no", length = 100) private String purchaseOrderNo;
    @Column(name = "receipt_no", length = 100) private String receiptNo;
    @Column(name = "delivery_note_no", length = 100) private String deliveryNoteNo;
    @Column(name = "invoice_no", length = 100) private String invoiceNo;
    @Column(name = "voucher_no", length = 100) private String voucherNo;
    @Column(name = "external_ref", length = 100) private String externalRef;
    @Column(length = 50) private String warehouse;
    @Column(name = "attachment_name", length = 255) private String attachmentName;
    @Column(name = "attachment_content_type", length = 100) private String attachmentContentType;
