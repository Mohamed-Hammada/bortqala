...
public final class OperationsApi {
    ...
    public record LedgerView(String id, String partyId, String partyName, String entryType, BigDecimal amountDelta,
                             String referenceCode, String note, Instant occurredAt, String createdBy,
                             Instant createdAt) {
    }

    public record PartyBalance(String partyId, String partyCode, String partyName, String partyType,
                               BigDecimal balance) {
    }

    public record AdvanceRequest(@NotBlank String employeeId,
                                 @NotNull @Digits(integer = 17, fraction = 2) BigDecimal amountDelta,
