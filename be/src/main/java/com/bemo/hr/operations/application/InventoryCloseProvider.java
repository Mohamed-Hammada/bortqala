...
public class InventoryCloseProvider implements ModuleCloseProvider {
    ...
    public InventoryCloseProvider(CloseBlockerQueryService queries) { this.queries = queries; }
    ...
    public Optional<String> getBlockerReason(String periodId) { long count = blockers(periodId); return count == 0 ? Optional.empty() : Optional.of(count + " inventory control document(s) remain unfinished"); }
