...
public class UnitConversion {
    ...
    @Column(name = "from_uom_id", nullable = false, length = 36) private String fromUomId;
    @Column(name = "to_uom_id", nullable = false, length = 36) private String toUomId;
    @Column(nullable = false, precision = 19, scale = 6) private BigDecimal factor;
    ...
    @jakarta.persistence.PrePersist void prePersist() { createdAt = Instant.now(); }

    public String getId() { return id; }
    public String getFromUomId() { return fromUomId; }
    public String getToUomId() { return toUomId; }
