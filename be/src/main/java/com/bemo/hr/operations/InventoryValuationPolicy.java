...
public class InventoryValuationPolicy {
    ...
    private Method valuationMethod;
    @Column(name = "inventory_account_id", length = 36)
    private String inventoryAccountId;
    @Column(name = "receipt_offset_account_id", length = 36)
    private String receiptOffsetAccountId;
    @Column(name = "cogs_account_id", length = 36)
    private String cogsAccountId;
    @Column(name = "adjustment_account_id", length = 36)
    private String adjustmentAccountId;
    @Column(name = "gl_posting_enabled", nullable = false)
    private boolean glPostingEnabled;
    @Column(name = "allow_backdated_posting", nullable = false)
    private boolean allowBackdatedPosting;
    @Version
