...
public class ItemLotSerial {
    ...
    public String getIssueReference() { return issueReference; }
    ...
    private static void requirePositive(BigDecimal value) {
        if (value == null || value.signum() <= 0) throw new IllegalArgumentException("Lot/serial quantity must be positive");
    }
}
