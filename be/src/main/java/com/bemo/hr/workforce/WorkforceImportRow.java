...
public class WorkforceImportRow {
    ...
    @Column(name = "raw_data", nullable = false, length = 4000) private String rawData;
    @Column(name = "worker_code", length = 50) private String workerCode;
    @Column(name = "worker_id", length = 36) private String workerId;
    @Column(name = "work_date", length = 10) private String workDate;
    @Column(name = "attendance_value", precision = 4, scale = 2) private BigDecimal attendanceValue;
    @Column(name = "validation_status", nullable = false, length = 20) private String validationStatus;
    ...
    public WorkforceImportRow(String batchId, int rowNumber, String rawData, String workerCode, String workerId,
        ...
        this.id = UUID.randomUUID().toString(); this.batchId = batchId; this.rowNumber = rowNumber;
        this.rawData = rawData; this.workerCode = workerCode; this.workerId = workerId; this.workDate = workDate;
        this.attendanceValue = attendanceValue; this.validationStatus = validationStatus;
