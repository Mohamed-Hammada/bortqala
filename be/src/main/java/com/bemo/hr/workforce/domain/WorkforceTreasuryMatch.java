...
@Entity
@Table(name = "workforce_treasury_matches")
public class WorkforceTreasuryMatch {
    ...
    protected WorkforceTreasuryMatch() {}

    public WorkforceTreasuryMatch(String paymentId, String bankTransactionId, BigDecimal matchedAmount) {
