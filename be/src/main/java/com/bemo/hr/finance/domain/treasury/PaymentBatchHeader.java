...
public class PaymentBatchHeader {
    ...
    public void deriveTotal(BigDecimal total) {
        this.totalAmount = total == null ? BigDecimal.ZERO : total;
    }
    ...
    private com.bemo.hr.shared.domain.BusinessRuleException conflict() {
        return new com.bemo.hr.shared.domain.BusinessRuleException(
