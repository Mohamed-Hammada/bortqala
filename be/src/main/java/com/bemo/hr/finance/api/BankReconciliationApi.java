...
public final class BankReconciliationApi {
    ...
    public record StatementResponse(String id, String bankAccountId, String statementReference, long periodStart,
            long periodEnd, BigDecimal openingBalance, BigDecimal closingBalance, String currencyCode,
            String fileName, String status, String importedBy, long importedAt, String reconciledBy,
    ...
    public record MatchResponse(String id, String journalEntryId, BigDecimal matchedAmount, String matchType,
            String status, String matchedBy, long matchedAt, String reversedBy, Long reversedAt, String reversalReason) { }
    public record CandidateResponse(String journalEntryId, String entryNumber, long entryDate, String description,
            String reference, BigDecimal bankAmount, BigDecimal availableAmount, int score, String reason) { }
    public record LineResponse(String id, int lineNumber, long transactionDate, Long valueDate, String description,
            ...
            BigDecimal matchedAmount, BigDecimal remainingAmount, long version, List<MatchResponse> matches,
    ...
    public record ReverseRequest(@NotBlank @Size(max = 80) String operationId, @NotBlank @Size(max = 500) String reason) { }
    ...
    public record CashPositionResponse(List<CashPositionLine> accounts, java.util.Map<String, BigDecimal> totalsByCurrency) { }
}
