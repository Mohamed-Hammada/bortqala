...
public class EffectiveMasterDataService {
    ...
    public EffectiveMasterValue add(String type, String id, String key, String value, LocalDate from, LocalDate to, String reason, String actor) {
        if (reason == null || reason.isBlank()) throw err("MASTER_VALUE_REASON_REQUIRED");
        if (from == null || (to != null && to.isBefore(from))) throw err("MASTER_VALUE_RANGE_INVALID");
        ...
        if (overlap) throw err("MASTER_VALUE_RANGE_OVERLAP");
