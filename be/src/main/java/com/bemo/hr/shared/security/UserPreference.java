...
public class UserPreference {
    ...
    @Column(name = "show_favorites", nullable = false) private boolean showFavorites = true;
    @Column(name = "show_recently_used", nullable = false) private boolean showRecentlyUsed = true;
    @Column(name = "max_recently_used", nullable = false) private int maxRecentlyUsed = 4;
    @Column(name = "favorite_menu_ids", nullable = false, length = 4000) private String favoriteMenuIds = "";
    @Column(name = "recent_menu_ids", nullable = false, length = 4000) private String recentMenuIds = "";
    ...
    public Set<String> favoriteMenuIds() { return parseMenuIds(favoriteMenuIds); }
    public Set<String> recentMenuIds() { return parseMenuIds(recentMenuIds); }
