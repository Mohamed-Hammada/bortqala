# VIRDI version-aware integration policy
...
- `src/supplier_virdi/versioning.py` — version constraint evaluator.
- `src/supplier_virdi/router.py` — strict route selection.
