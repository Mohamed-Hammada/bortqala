# HONEYWELL version-aware integration policy
...
- `src/supplier_honeywell/versioning.py` — version constraint evaluator.
- `src/supplier_honeywell/router.py` — strict route selection.
