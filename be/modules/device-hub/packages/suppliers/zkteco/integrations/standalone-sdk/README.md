...
**Type:** `native-sdk`  
**Purpose:** Standalone SDK / zkemkeeper COM bridge  
**Use when:** Legacy Windows-supported terminals
...
This route is represented by `supplier_zkteco.adapters.standalone_sdk`. Public HTTP/TCP probes are implemented where safe. Native/proprietary SDK calls are isolated behind a bridge and require the supplier's licensed binaries/manuals.
