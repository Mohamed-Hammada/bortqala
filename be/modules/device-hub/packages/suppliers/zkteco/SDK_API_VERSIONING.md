# ZKTECO version-aware integration policy
...
- `src/supplier_zkteco/versioning.py` — version constraint evaluator.
- `src/supplier_zkteco/router.py` — strict route selection.
