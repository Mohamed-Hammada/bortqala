# DAHUA version-aware integration policy
...
- `src/supplier_dahua/versioning.py` — version constraint evaluator.
- `src/supplier_dahua/router.py` — strict route selection.
