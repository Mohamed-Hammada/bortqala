# ANVIZ version-aware integration policy
...
- `src/supplier_anviz/versioning.py` — version constraint evaluator.
- `src/supplier_anviz/router.py` — strict route selection.
