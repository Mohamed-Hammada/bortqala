# HIKVISION version-aware integration policy
...
- `src/supplier_hikvision/versioning.py` — version constraint evaluator.
- `src/supplier_hikvision/router.py` — strict route selection.
