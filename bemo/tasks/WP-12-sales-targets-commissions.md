...
- [ ] **AC-5** Statement export localized; "send to payroll" appears once per rep/period and is idempotent (second click disabled server-side). *(Deferred — export + payroll bonus injection not yet implemented)*
