...
@Component({
  ...
  `,
  styles: [`
    .page{padding: 1.5rem;display: grid;gap: 1.25rem}.eyebrow{color: #b7791f;font-weight: 800}header h1{margin: .2rem 0}.steps{display: grid;grid-template-columns: repeat(6,1fr);list-style: none;padding: 0;margin: 0;gap: .5rem}.steps li{padding: .7rem;text-align: center;background: var(--surface-muted);color: var(--muted);border-radius: 10px}.steps li.active{background: var(--warning-soft);color: var(--warning-text);font-weight: 800}.grid{display: grid;grid-template-columns: minmax(0,2fr) minmax(320px,1fr);gap: 1rem}.card{background: var(--surface);border: 1px solid var(--line);border-radius: 14px;padding: 1.2rem}.workflow{display: grid;gap: 1rem}.workflow section{border-bottom: 1px solid var(--line);padding-bottom: 1rem}.workflow section:last-child{border: 0}.btn{border: 0;border-radius: 8px;padding: .6rem .85rem;margin: .25rem;font-weight: 800;cursor: pointer;background: var(--surface-muted)}.btn:disabled{opacity: .5}.primary{background: #b7791f;color: #fff}.danger{background: var(--danger-soft);color: var(--danger)}.mapping{display: grid;grid-template-columns: repeat(3,1fr);gap: .7rem}.mapping label{display: grid;gap: .3rem;font-weight: 700}.mapping select,input[type=file]{padding: .6rem;border: 1px solid var(--line);border-radius: 8px}.batch-head,.summary,.history{display: flex;justify-content: space-between;gap: .8rem;align-items: center}.status{background: var(--surface-muted);border-radius: 999px;padding: .25rem .6rem}.summary{justify-content: flex-start}.summary span{padding: .6rem;border-radius: 8px;background: var(--surface-muted)}.summary .ok{background: var(--success-soft)}.summary .bad{background: var(--danger-soft)}.alert{padding: .75rem;border-radius: 9px}.error{background: var(--danger-soft);color: var(--danger)}.warning{background: var(--warning-soft);color: var(--warning-text)}.table-wrap{overflow: auto;margin: .8rem 0}table{width: 100%;border-collapse: collapse}th,td{padding: .55rem;border-bottom: 1px solid var(--line);text-align: right}td small,.history small{display: block;color: var(--muted)}.invalid{background: var(--danger-soft)}.check{display: block;padding: .6rem;background: var(--warning-soft)}.history{display: grid;grid-template-columns: 1fr auto;padding: .8rem 0;border-bottom: 1px solid var(--line)}.history-actions{grid-column: 1/-1}.link{border: 0;background: transparent;color: #946200;text-decoration: underline;cursor: pointer}.danger-text{color: var(--danger)}.report-link{display: block;padding: .8rem;background: var(--surface-muted);border-radius: 9px;color: var(--warning-text)}.muted{color: var(--muted);font-size: .9rem}@media(max-width: 950px){.grid{grid-template-columns: 1fr}.steps{grid-template-columns: repeat(3,1fr)}.mapping{grid-template-columns: 1fr}}
  `]
})
