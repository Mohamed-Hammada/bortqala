...
describe('DashboardStore', () => {
  ...
  it('loads multi-period trends into the trends signal', async () => {
    ...
    const promise = store.loadTrends(6);
    const request = httpMock.expectOne('/api/v1/dashboard/trends?months=6');
  ...
  it('downloads the multi-period trends workbook', async () => {
    const promise = store.downloadTrends(12);
    const request = httpMock.expectOne('/api/v1/exports/trends.xlsx?months=12');
