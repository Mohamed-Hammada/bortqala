...
Acceptance:
- [x] Every affected route opens as Super Admin.
- [x] Restricted roles remain restricted.
- [x] Sidebar visibility matches route/API authorization.
- [x] Direct URL access matches sidebar behavior.
- [x] Automated authorization regression tests added.
