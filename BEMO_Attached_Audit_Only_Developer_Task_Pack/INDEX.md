...
- [ ] 10 — BUG-010 — Inventory movement lacks distinct document references
- [ ] 11 — BUG-011 — Duplicate inventory unit headers
- [ ] 12 — BUG-012 — Save feedback is too generic
- [ ] 13 — BUG-013 — Required-field validation lacks visible explanation
- [ ] 14 — BUG-014 — Raw translation key visible
- [ ] 15 — BUG-015 — Mixed Arabic/English terminology
- [ ] 16 — BUG-016 — Report shortcut action is ambiguous
- [ ] 17 — BUG-017 — Dashboard report-cycle wording is misleading
- [ ] 18 — BUG-018 — Missing accessibility names
- [ ] 19 — BUG-019 — Contractor failure lacks recovery guidance
- [ ] 20 — BUG-020 — Workforce category form/table rule fields inconsistent
